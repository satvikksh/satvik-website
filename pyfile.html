<!-- semester 3rd python file subject -->
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="sub3.html">File</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link active" href="ca.html">Python</a>
                    </li>
    ...
    <div class="container my-5">
        ...
        <div class="row featurette d-flax justify-content-center align-items-center">
            <div class="col-md-5">
                ...
                <p class="lead">There has complete file avaliable.
            ...
            <div class="col-md-3">
                <a href="file\python\unit1" target="_blank">
