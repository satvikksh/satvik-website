...
if(isset($_POST['save'])){
    ...
    $query=mysqli_query($conn,"select * from department where departmentname ='$departmentname'");
    ...
    if($ret > 0){ 
        ...
        $query=mysqli_query($conn,"insert into department(departmentname) value('$departmentname')");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        if(isset($_POST['update'])){
            ...
            $query=mysqli_query($conn,"update department set departmentname='$departmentname' where Id='$Id'");
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="departmentname" value="<?php echo $row['departmentname'];?>" id="exampleInputFirstName" placeholder="Department Name">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
