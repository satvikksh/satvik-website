...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="sub3.html">Notes</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link active" href="os.html">OS</a>
                    </li>
    ...
    <div class="container my-5">
        ...
        <div class="row featurette d-flax justify-content-center align-items-center">
            ...
            <div class="col-md-3">
                <a href="https://1drv.ms/b/s!AvpBRq-K-fpvglbfPUXwCioxIZCR" target="_blank">
        ...
        <div class="row featurette d-flax justify-content-center align-items-center">
            <div class="col-md-5 order-md-2">
                ...
                <p class="lead">There has complete notes available.
                <h4>Check out! HEAR 👈👈 click on the icon.</h4>
                </p>

            </div>
            <div class="col-md-3">
                <a href="https://1drv.ms/b/s!AvpBRq-K-fpvgxF9JO-_GLye3JGM" target="_blank">
        ...
        <div class="row featurette d-flax justify-content-center align-items-center">
            ...
            <div class="col-md-7">
                <a href="https://1drv.ms/b/s!AvpBRq-K-fpvgxT7oKqJlLfDJvk2"target="_blank">
