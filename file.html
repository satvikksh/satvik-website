        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="2nd.png">Semester 2nd</a>
                    </li>

                    
                    <li class="nav-item">
                        <a class="nav-link active" href="sub.html">File</a>
                    </li>
        ...
        <div class="row featurette d-flax justify-content-center align-items-center">
            <div class="col-md-7">
                <h2 class="featurette-heading">Hallo guys! <span class="text-muted">Notes for you
                        .</span></h2>
                <p class="lead">There has complete c-programming file avaliable.
            ...
            <div class="row featurette d-flax justify-content-center align-items-center">
                <div class="col-md-7">
                    <h2 class="featurette-heading">Hello guys! <span class="text-muted">Notes for you
                            .</span></h2>
                    <p class="lead">There has complete DT file available.
                    <h4>Check out! HEAR 👉👉  click on the icon.</h4>
                    </p>
            ...
            <div class="row featurette d-flax justify-content-center align-items-center">
                <div class="col-md-7">
                    <h2 class="featurette-heading">Hallo guys! <span class="text-muted">Notes for you
                            .</span></h2>
                    <p class="lead">There has complete BEEM file available.
            ...
            <div class="row featurette d-flax justify-content-center align-items-center">
                <div class="col-md-7">
                    <h2 class="featurette-heading">Hallo guys! <span class="text-muted">Notes for you
                            .</span></h2>
                    <p class="lead">There has complete EES file available.
